...
export function TopNav() {
  ...
  const roleConfig = {
    test_engineer: { name: '测试工程师', color: 'blue', bgColor: 'from-blue-600 to-blue-700', textColor: 'text-blue-700', bgLight: 'bg-blue-50', borderColor: 'border-blue-200' },
    process_engineer: { name: '工艺工程师', color: 'green', bgColor: 'from-green-600 to-green-700', textColor: 'text-green-700', bgLight: 'bg-green-50', borderColor: 'border-green-200' },
    maintenance_engineer: { name: '台架维护工程师', color: 'orange', bgColor: 'from-orange-600 to-orange-700', textColor: 'text-orange-700', bgLight: 'bg-orange-50', borderColor: 'border-orange-200' },
  };
  ...
  return (
    <nav className="bg-white text-slate-900 px-6 py-3 flex items-center justify-between fixed top-0 left-0 right-0 z-50 shadow-sm border-b border-slate-200">
      <div className="flex items-center gap-3">
        <div className={`w-8 h-8 bg-gradient-to-br ${currentConfig.bgColor} rounded-lg flex items-center justify-center shadow-sm`}>
      ...
      <div className="flex items-center gap-4">
        <div className="relative" ref={menuRef}>
          ...
          >
            <div className={`w-8 h-8 bg-gradient-to-br ${currentConfig.bgColor} rounded-full flex items-center justify-center`}>
            ...
            <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-lg shadow-lg border border-slate-200 py-2 z-50">
              ...
              {(Object.keys(roleConfig) as UserRole[]).map((role) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-6 h-6 bg-gradient-to-br ${config.bgColor} rounded-full flex items-center justify-center`}>
